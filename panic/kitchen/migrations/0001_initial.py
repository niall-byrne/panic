          ...
          fields=[
              ('id',
               models.AutoField(auto_created=True,
                                ...
                                serialize=False,
                                verbose_name='ID')),
              ('content', kitchen.fields.BlondeCharField(max_length=255)),
          ],
      ),
      migrations.CreateModel(
          name='BleachNullableContent',
          fields=[
              ('id',
               models.AutoField(auto_created=True,
                                primary_key=True,
                                ...
                                verbose_name='ID')),
              ('content',
               kitchen.fields.BlondeCharField(blank=True,
                                              max_length=255,
                                              null=True)),
          ],
      ),
          ...
          fields=[
              ('id',
               models.AutoField(auto_created=True,
                                ...
                                verbose_name='ID')),
              ('name',
               kitchen.fields.BlondeCharField(max_length=255, unique=True)),
